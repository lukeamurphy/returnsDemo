...
export default function CostSavingsChart({ returns, blockedRuleName = "Block if Order Older Than 30 Days" }) {
  ...
  // Round the cost savings for display purposes.
  const roundedCostSavings = Math.round(costSavings);

  // Set a fixed target for cost savings. For example, $1,000.
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      ...
      >
        ...
        <YAxis
          stroke="#333"
          domain={[0, targetSavings]}  // Fixed domain from 0 to targetSavings
